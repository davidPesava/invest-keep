			...
			<v-col cols="12">
				<v-expansion-panels>
					<v-expansion-panel>
						...
						v-expansion-panel-content>< Currently stocks and forex. </v-expansion-panel-content> </v-expansion-panel> </v-expansion-panels> </v-col> </v-row> </div> <div class="default-layout__block" id="about">
							<v-row>
